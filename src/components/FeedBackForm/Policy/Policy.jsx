...
const Policy = (props) => {
  ...
  return (
    <div>
      <label htmlFor="policy" color="danger">
        {buttonLabel}{" "}
        <svg
          style={baseStyle}
          onClick={toggle}
      ...
      <Modal size="lg" isOpen={modal} toggle={toggle} className={className}>
        <ModalBody>
          ...
          <h4>
            ...
            данных, предпринимаемые Мельником Павлом Викторовичем (далее –
            Оператор).
          </h4>
          <ul>
            ...
            <li>
              ...
              веб-сайта{" "}
              <a href="http://portfolio.pavelmelnik.ru">
                http://portfolio.pavelmelnik.ru
              </a>
              .
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              {" "}
              4.1. Цель обработки персональных данных Пользователя — Данные
              обратной связи.{" "}
            </li>
            <li>
              {" "}
              ...
              <a href="mailto:recyclesordie94@gmail.com">
          ...
          <ul>
            ...
            <li>
              ...
              <a href="http://pavelmelnik.ru/policy.html">
                http://pavelmelnik.ru/policy.html/
              </a>{" "}
              .{" "}
            </li>
          </ul>
